...
public class Alquileres implements IAlquileres {
	...
	public List<Alquiler> get()
	{
		...
		FindIterable<Document> coleccionAlquileresOrdenada=coleccionAlquileres.find().sort(Sorts.ascending(MongoDB.FECHA_ALQUILER,MongoDB.CLIENTE_DNI));
	...
	public List<Alquiler> get(Cliente cliente)
	{
		...
		for (Document documentoAlquiler : coleccionAlquileres.find().filter(eq(MongoDB.CLIENTE_DNI, cliente.getDni()))) {
	...
	public List<Alquiler> get(Vehiculo vehiculo)
	{
		...
		for (Document documentoAlquiler : coleccionAlquileres.find().filter(eq(MongoDB.VEHICULO_MATRICULA, vehiculo.getMatricula()))) {
	...
	{
		getInstancia().coleccionAlquileres.updateOne(eq(MongoDB.CLIENTE_DNI,cliente.getDni()), Updates.set(MongoDB.CLIENTE_NOMBRE, nombre));
	}
	
	public static void modificarTelefonoCliente(Cliente cliente, String telefono)
	{
		getInstancia().coleccionAlquileres.updateOne(eq(MongoDB.CLIENTE_DNI,cliente.getDni()), Updates.set(MongoDB.CLIENTE_TELEFONO, telefono));
	}
