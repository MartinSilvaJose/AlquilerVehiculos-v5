...
public class Vehiculos implements IVehiculos {
	...
	public List<Vehiculo> get()
	{
		...
		FindIterable<Document> coleccionVehiculosOrdenada=coleccionVehiculos.find().sort(Sorts.ascending(MongoDB.MATRICULA));
	...
	{
		Document documentoVehiculo = coleccionVehiculos.find().filter(eq(MongoDB.MATRICULA, vehiculo.getMatricula())).first();
