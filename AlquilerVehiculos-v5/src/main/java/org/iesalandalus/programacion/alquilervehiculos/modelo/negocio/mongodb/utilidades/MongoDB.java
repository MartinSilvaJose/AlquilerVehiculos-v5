...
public class MongoDB {
	...
	public static Cliente getCliente(Document documentoCliente) {
		...
		return new Cliente(documentoCliente.getString(NOMBRE), documentoCliente.getString(DNI), documentoCliente.getString(TELEFONO));
	}
	...
	public static Vehiculo getVehiculo(Document documentoVehiculo) {
		...
		{
			vehiculo=new Turismo(documentoVehiculo.getString(MARCA),documentoVehiculo.getString(MODELO),documentoVehiculo.getInteger(CILINDRADA),documentoVehiculo.getString(MATRICULA));			
		}
		else if (tipo.equals(TIPO_AUTOBUS))
		{
			vehiculo=new Autobus(documentoVehiculo.getString(MARCA),documentoVehiculo.getString(MODELO),documentoVehiculo.getInteger(PLAZAS),documentoVehiculo.getString(MATRICULA));
		}
		else if (tipo.equals(TIPO_FURGONETA))
			vehiculo=new Furgoneta(documentoVehiculo.getString(MARCA),documentoVehiculo.getString(MODELO),documentoVehiculo.getInteger(PMA),documentoVehiculo.getInteger(PLAZAS),documentoVehiculo.getString(MATRICULA));
	...
	public static Document getDocumento(Alquiler alquiler) {
		...
		return new Document().append(CLIENTE, dCliente).append(VEHICULO, dVehiculo).append(FECHA_ALQUILER, fechaAlquiler).append(FECHA_DEVOLUCION, fechaDevolucion);
	}
